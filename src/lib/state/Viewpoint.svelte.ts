...
export class ViewPoint {
	...
	get isDesktop() { return this._state.isDesktop; }
	get isMobile() { return this._state.isMobile; }
	get isTablet() { return this._state.isTablet; }
...
const VIEWPOINT_KEY = Symbol('PWA_VIEWPOINT');
